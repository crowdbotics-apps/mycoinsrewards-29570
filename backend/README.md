...
## Project Structure
    ...
    ├── mycoinsrewards_29570  # Django project configurations
...
1. Clone this repo and `cd mycoinsrewards_29570`
...
2. Clone this repo and `cd mycoinsrewards_29570`
